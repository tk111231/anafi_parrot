...
def moveby_dpi2(drone):
    azimuth_rad1=moveby_dpi1(drone)
    ...
    print('---------------rad2 is '+str(azimuth_rad2)+'---------------')
    drone(
...
def moveby_dpi3(drone):
    azimuth_rad2=moveby_dpi2(drone)
    s, α1, α2 = vincenty_inverse(drone,lat2,lat3,lon2,lon3,ellipsoid=1)
    azimuth_rad = α1+(pi/2)
    # 1回目の角度の方が大きかった場合の処理
    ...
    print('---------------rad2 is '+str(azimuth_rad3)+'---------------')
    drone(
...
def moveby_dpi4(drone):
    azimuth_rad3=moveby_dpi3(drone)
    start_lat, start_lon = moveby_dy1(drone)
    ...
    print('---------------rad2 is '+str(azimuth_rad4)+'---------------')
    drone(
